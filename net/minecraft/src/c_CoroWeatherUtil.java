...
public class c_CoroWeatherUtil
{
    ...
    public static int getEntityAge(EntityLiving ent)
    {
        return ent.entityAge;
    }

    public static void setEntityAge(EntityLiving ent, int val)
    {
        ent.entityAge = val;
    }
    ...
    public static boolean getIsJumping(EntityLiving ent)
    {
