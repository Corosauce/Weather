...
public class EntShockWave extends Entity
{
    ...
    {
        List var3 = this.worldObj.getEntitiesWithinAABB(EntityLiving.class, AxisAlignedBB.getBoundingBox((double)var1, this.posY, (double)var2, (double)var1 + 1.0D, this.posY + 1.0D, (double)var2 + 1.0D).expand(1.0D, 1.0D, 1.0D));
