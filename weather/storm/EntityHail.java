...
public class EntityHail extends Entity
{
    ...
    public EntityHail(World var1, EntityLiving var2)
    {
        super(var1);
    ...
    public EntityHail(World var1, double var2, double var4, double var6)
    {
        super(var1);
    ...
    public void onUpdate()
    {
        ...
        if (var3 != null)
        {
            ...
            {
                worldObj.setBlockWithNotify((int)var3.hitVec.xCoord, (int)var3.hitVec.yCoord, (int)var3.hitVec.zCoord, 0);
            }
        }
