...
public class SoundLoader {
    ...
    public void onSound(SoundLoadEvent event) {
		...
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/destruction_s.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/destructionb.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/siren.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/wind_close.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/wind_close_0_.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/wind_close_1_.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/wind_close_2_.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/wind_far.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/wind_far_0_.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/wind_far_1_.ogg");
		registerStreaming(event.manager, WeatherMod.modID + ":tornado/wind_far_2_.ogg");
    }
