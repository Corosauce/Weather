...
public class ItemSurfboard extends Item
{
    public ItemSurfboard(int par1)
    {
        super(par1);
        this.maxStackSize = 1;
            ...
            else
            {
                if (var24.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    if (!par2World.isRemote)
                    {
                        ...
                        par2World.spawnEntityInWorld(new EntitySurfboard(par2World, (double)((float)var35 + 0.5F), (double)((float)var33 + 1.0F), (double)((float)var34 + 0.5F)));
                    }
