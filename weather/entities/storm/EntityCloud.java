...
public class EntityCloud extends Entity
{
    ...
    public EntityCloud(World var1, EntityLivingBase var2)
    {
        super(var1);
    ...
    public EntityCloud(World var1, double var2, double var4, double var6)
    {
        super(var1);
